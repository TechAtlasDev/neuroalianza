...
const RESOURCES: ResourceItem[] = [
  ...
  {
    id: "4",
    title: "Video: Detección oportuna de contacto visual y sonrisa social",
    category: "videos",
    ...
    rating: "4.99",
    ratingsCount: 310,
    location: "Capacitación Telesalud · INSN-SB",
    image: "https://images.unsplash.com/photo-1587654780291-39c9404d746b?auto=format&fit=crop&w=800&q=80",
    description: "Video explicativo paso a paso sobre cómo evaluar la respuesta al nombre, la atención conjunta y el juego recíproco.",
    summaryPoints: [
      "Prueba de llamada por su nombre a 1 metro sin estimulación táctil.",
      "Observación de señalamiento para compartir interés en juguetes.",
      "Identificación de respuestas comunicativas espontáneas.",
    ],
