      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/80 bg-background/85 backdrop-blur-md">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/app">
              <Button className="gap-2 font-semibold shadow-md shadow-primary/25 min-h-[40px] px-5">
            ...
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-4">
                <Link to="/app" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto min-h-[48px] px-8 text-base font-semibold gap-2 shadow-lg shadow-primary/25">
                    <span>Iniciar PWA Mobile</span>
                    <ArrowRight className="w-5 h-5" />
                  </Button>
                </Link>
                <Link to="/app/demo" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto min-h-[48px] px-6 text-base font-medium gap-2">
                    <Sparkles className="w-4 h-4 text-primary" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-12 text-left">
                <div className="p-4 rounded-2xl bg-card border border-border/80 shadow-sm">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">Ventana crítica de máxima plasticidad cerebral</p>
                </div>
                <div className="p-4 rounded-2xl bg-card border border-border/80 shadow-sm">
                  <p className="text-2xl sm:text-3xl font-extrabold text-primary font-heading">&lt; 3 min</p>
                  <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">Tamizaje estandarizado rápido en postas CRED</p>
                </div>
                <div className="p-4 rounded-2xl bg-card border border-border/80 shadow-sm">
                  <p className="text-2xl sm:text-3xl font-extrabold text-primary font-heading">360°</p>
                  <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">Ficha multidisciplinaria para especialistas INSN-SB</p>
                </div>
                <div className="p-4 rounded-2xl bg-card border border-border/80 shadow-sm">
                  <p className="text-2xl sm:text-3xl font-extrabold text-primary font-heading">100% PWA</p>
                  <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">Mobile-First accesible con soporte offline</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <Card className="hover:border-primary/50 transition-all hover:shadow-lg flex flex-col justify-between">
              ...
              <CardContent className="pt-0">
                <Link to="/app/salud">
                  <Button className="w-full min-h-[44px] gap-2 font-medium" variant="outline">
            ...
            <Card className="hover:border-primary/50 transition-all hover:shadow-lg border-primary/30 relative flex flex-col justify-between">
              ...
              <CardContent className="pt-0">
                <Link to="/app/familia">
                  <Button className="w-full min-h-[44px] gap-2 font-semibold">
