    ...
    <div className="space-y-4">
      ...
      <Card className="border-primary/20 bg-card">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-muted-foreground font-medium">Turno Mañana</span>
          </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="p-3 rounded-xl bg-card border border-border text-center">
          ...
          <p className="text-[11px] text-muted-foreground font-medium">Evaluados Hoy</p>
        </div>
        <div className="p-3 rounded-xl bg-card border border-border text-center">
          <p className="text-xl font-bold text-amber-600 font-heading">2</p>
          <p className="text-[11px] text-muted-foreground font-medium">Observación</p>
        </div>
        <div className="p-3 rounded-xl bg-card border border-border text-center">
          <p className="text-xl font-bold text-destructive font-heading">1</p>
          <p className="text-[11px] text-muted-foreground font-medium">Derivado INSN</p>
        </div>
      </div>
      ...
      <section className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Card className="border-border">
            <CardContent className="p-3 flex items-center justify-between">
              <div>
                <p className="text-sm font-bold text-foreground">Sofía Mendoza P. (24 m)</p>
