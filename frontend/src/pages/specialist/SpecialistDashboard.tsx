  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="border-indigo-500/20 bg-card shadow-sm">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-md text-muted-foreground font-semibold">Neuropediatría</span>
          </div>
        ...
        <CardContent className="pt-0">
          <div className="grid grid-cols-3 gap-2 text-center">
            <div className="p-2.5 rounded-lg bg-muted/40 border border-border">
              ...
              <p className="text-md text-muted-foreground">Derivaciones</p>
            </div>
            <div className="p-2.5 rounded-lg bg-muted/40 border border-border">
              <p className="text-lg font-bold text-indigo-600 font-heading">3</p>
              <p className="text-md text-muted-foreground">Admitidos</p>
            </div>
            <div className="p-2.5 rounded-lg bg-muted/40 border border-border">
              <p className="text-lg font-bold text-emerald-600 font-heading">100%</p>
              <p className="text-md text-muted-foreground">Articulación</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <section className="space-y-2">
        <div className="flex items-center justify-between">
          <h3 className="text-md font-bold text-foreground">Casos Prioritarios Entrantes</h3>
          <Badge variant="secondary" className="text-md">Filtro CRED</Badge>
        </div>
        ...
        <Card className="border-destructive/30 bg-destructive/5">
          <CardContent className="p-3.5 space-y-2">
            <div className="flex items-start justify-between gap-2">
              <div>
                <Badge variant="destructive" className="text-md uppercase font-bold py-0">
                  Alto Riesgo (TEA / Lenguaje)
                </Badge>
                <h4 className="text-md font-bold text-foreground mt-1">
            ...
            <p className="text-md text-foreground/90 bg-background/80 p-2.5 rounded-lg border border-border">
            ...
            <div className="flex gap-2 pt-1">
              <Button size="sm" className="flex-1 min-h-10 gap-1.5 font-semibold text-md">
                <UserCheck size={16} weight="bold" />
                <span>Admitir y Agendar Cita 360°</span>
              </Button>
              <Button size="sm" variant="outline" className="min-h-10 text-md">
                Ver Video
              </Button>
            </div>
          </CardContent>
