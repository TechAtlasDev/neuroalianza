  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="border-primary/40 bg-gradient-to-br from-primary/10 via-card to-card">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-md text-muted-foreground font-semibold">Pitch Demo</span>
          </div>
        ...
        <CardContent className="pt-0 space-y-2">
          <div className="flex gap-2">
            <Button
              ...
              className="flex-1 min-h-10 gap-1 text-md font-semibold"
            >
            ...
            <Button
              ...
              className="min-h-10 px-3 text-md"
            >
      ...
      <section className="space-y-2.5">
        <h3 className="text-md font-bold text-foreground">Ruta del Caso Demostración</h3>
                  ...
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-1.5">
                      {isCompleted ? (
                        ...
                        <span className="w-4 h-4 rounded-full bg-primary/20 text-primary text-md font-bold flex items-center justify-center">
                          {stage.step}
                        </span>
                      )}
                      <p className="text-md font-bold text-foreground">{stage.title}</p>
                    </div>
                    <p className="text-md text-muted-foreground pl-5">{stage.desc}</p>
                  </div>

                  <Link to={stage.path}>
                    <Button size="sm" className="h-8 text-md font-semibold px-2.5 gap-1">
                      <span>Ver</span>
